public class Main {
    ...
    public static void task6(){
        byte age= 19;
        int salary= 58_000, credit= 0, credit1= 0, credit2= 0;
        if(age < 23) credit1= salary*2; else credit1= salary*3;
        if(salary >= 50000 && salary < 80000) credit2= (salary/10)*12;
        else if(salary >= 80000) credit2= (salary/10)*15;
        if(credit1 > credit2) credit=credit1; else credit=credit2;
